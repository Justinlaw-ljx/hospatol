...
<form name=ThisForm action="<%=path %>/userLogin.action" method="POST">
                                  ...
                                  <TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TABLE style="FONT-SIZE: 12px" cellSpacing=0 cellPadding=0 width="92%" align=center border=0>
                                            ...
                                            <TR align="center">
                                                  <TD height=75 colSpan=2 align="center"><input name="imageField" type="image" onClick="return check();" src="<%=path %>/images/login_19.gif">
                                                  <TD height=50 colSpan=2 valign="bottom"><input name="Register" type="button" value="返回" onClick="window.location.href='/hospatol/admin/login.jsp';"></TD>
                                           </TR>
				       <!--  <TR >
				              <TD valign="middle">
				                  <select name="kind">
