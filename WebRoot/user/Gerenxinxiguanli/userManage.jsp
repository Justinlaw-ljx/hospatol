				...
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()" onmouseout="changeback()">
						<tr>
							...
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center">
									<span class="STYLE10">用户真实姓名</span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center">
									<span class="STYLE10">用户手机号码</span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center">
									<span class="STYLE10">用户邮箱地址</span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center">
                        ...
                        <tr>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE10"><s:property value="#user.userId"/></span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE10"><s:property value="#user.userRealname"/></span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
							...
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE10"><s:property value="#user.userEmail"/></span>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
								    <span class="STYLE10"><img width="10" height="10" src="images/edit.gif" />&nbsp;&nbsp;&nbsp;<a href="<%=path %>/userEdit.action?userId=<s:property value="#user.userId"/>">编辑</a></span>&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
							</td>
						</tr>
                        </s:iterator>
