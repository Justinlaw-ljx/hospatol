                  ...
                  <TBODY>
                    <TR>
                      <TD height=54 valign="top" background="<%=path %>/images/admin_3_4.gif"><table width="70%"  border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><div style="FONT-WEIGHT: bold; FONT-SIZE: 23pt; FILTER: Glow(Color=#00347F,Strength=4); WIDTH: 100%; COLOR: #ffffff; font-family: 黑体">医院信息管理系统</div></td>
                          </tr>
                      </table></TD>
                    </TR>
                  </TBODY>
                                  ...
                                  <TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TABLE style="FONT-SIZE: 12px" cellSpacing=0 cellPadding=0 width="92%" align=center border=0>
                                            ...
                                            <TR align="center">
                                                  <TD height=50 colSpan=1 valign="bottom"><input name="Login" type="submit" value="管理员登录" onClick="return check();"></TD>
                                                  <TD height=50 colSpan=2 valign="bottom"><input name="Patient" type="button" value="普通用户登录" onClick="window.location.href='/hospatol/user/login2.jsp';"></TD>
                                                  <TD height=50 colSpan=2 valign="bottom"><input name="Register" type="button" value="普通用户注册" onClick="window.location.href='/hospatol/admin/user_reg.jsp';"></TD>                                      
                                           </TR>
				       <!--  <TR >
				              <TD valign="middle">
				                  <select name="kind">
